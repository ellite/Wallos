...
function resetForm() {
  ...
  autoRenew.checked = typeof window.defaultAutoRenew !== 'undefined' ? window.defaultAutoRenew : false;
  const notifications = document.querySelector("#notifications");
  notifications.checked = typeof window.defaultNotifications !== 'undefined' ? window.defaultNotifications : true;
