let i18n = {
  ...
  notes: "Белешке",
  export: "Извоз",
  // Акције и статус пројекта
  new_project: "Нови пројекат",
  edit_project: "Уреди пројекат",
  project_deleted_successfully: "Пројекат је успешно обрисан",
  // Поруке за потврду
  delete_project_confirmation: "Да ли сте сигурни да желите да обришете овај пројекат и све његове претплате? Ова радња се не може опозвати!",
  // Поруке о грешци
  error_reloading_project_list: "Грешка при поновном учитавању листе пројеката:",
  error_loading_project_info: "Није успело учитавање информација о пројекту:",
  error_fetching_project_info: "Грешка при добављању информација о пројекту:",
  error_deleting_project: "Грешка при брисању пројекта",
}
