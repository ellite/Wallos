let i18n = {
  ...
  notes: "Σημειώσεις",
  export: "Εξαγωγή",
  // Ενέργειες και κατάσταση έργου
  new_project: "Νέο έργο",
  edit_project: "Επεξεργασία έργου",
  project_deleted_successfully: "Το έργο διαγράφηκε με επιτυχία",
  // Μηνύματα επιβεβαίωσης
  delete_project_confirmation: "Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτό το έργο και όλες τις συνδρομές του; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί!",
  // Μηνύματα σφάλματος
  error_reloading_project_list: "Σφάλμα κατά την επαναφόρτωση της λίστας έργων:",
  error_loading_project_info: "Η φόρτωση των πληροφοριών του έργου απέτυχε:",
  error_fetching_project_info: "Σφάλμα κατά την ανάκτηση των πληροφοριών του έργου:",
  error_deleting_project: "Σφάλμα κατά τη διαγραφή του έργου",
}
