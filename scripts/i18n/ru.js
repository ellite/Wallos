let i18n = {
  ...
  notes: "Примечания",
  export: "Экспорт",
  // Действия и статус проекта
  new_project: "Новый проект",
  edit_project: "Редактировать проект",
  project_deleted_successfully: "Проект успешно удален",
  // Сообщения для подтверждения
  delete_project_confirmation: "Вы уверены, что хотите удалить этот проект и все его подписки? Это действие необратимо!",
  // Сообщения об ошибках
  error_reloading_project_list: "Ошибка при перезагрузке списка проектов:",
  error_loading_project_info: "Не удалось загрузить информацию о проекте:",
  error_fetching_project_info: "Ошибка при получении информации о проекте:",
