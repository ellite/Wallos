...
$i18n = [
    ...
    "new_subscription_defaults" => "Podrazumevane vrednosti novog pretplatnog plana",
    "default_auto_renew" => "Podrazumevano omogući automatsko obnavljanje",
    "default_notifications" => "Podrazumevano omogući obaveštenja",
