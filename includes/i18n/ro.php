...
$i18n = [
    ...
    "user_email_waiting_verification" => "Adresa de e-mail trebuie confirmată. Te rugăm să verifici e-mailul.",
    // Password Reset Page
    "forgot_password" => "Ai uitat parola?",
    "reset_password" => "Resetare Parolă",
    "reset_sent_check_email" => "E-mail de resetare trimis. Te rugăm să verifici e-mailul.",
