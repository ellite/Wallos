...
$i18n = [
    ...
    "new_subscription_defaults" => "Valori implicite abonament nou",
    "default_auto_renew" => "Activează reînnoirea automată implicit",
    "default_notifications" => "Activează notificările implicit",
