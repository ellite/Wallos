...
$i18n = [
    ...
    "new_subscription_defaults" => "Padrões para nova assinatura",
    "default_auto_renew" => "Habilitar renovação automática por padrão",
    "default_notifications" => "Habilitar notificações por padrão",
