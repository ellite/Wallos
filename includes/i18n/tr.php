...
$i18n = [
    ...
    "new_subscription_defaults" => "Yeni Abonelik Varsayılanları",
    "default_auto_renew" => "Otomatik yenilemeyi varsayılan olarak etkinleştir",
    "default_notifications" => "Bildirimleri varsayılan olarak etkinleştir",
