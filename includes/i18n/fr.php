...
$i18n = [
    ...
    "new_subscription_defaults" => "Valeurs par défaut d'un nouvel abonnement",
    "default_auto_renew" => "Activer le renouvellement automatique par défaut",
    "default_notifications" => "Activer les notifications par défaut",
