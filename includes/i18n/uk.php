...
$i18n = [
    ...
    "new_subscription_defaults" => "Стандартні значення нової підписки",
    "default_auto_renew" => "Увімкнути автоматичне поновлення за замовчуванням",
    "default_notifications" => "Увімкнути сповіщення за замовчуванням",
