...
$i18n = [
    ...
    "repeat_until_paid" => "Повторювати сповіщення щодня до оплати",
    "repeat_until_paid_info" => "Коли увімкнено, сповіщення надсилатимуться щодня з дати нагадування, доки ви не позначите підписку як оплачену.",
    "telegram_message_template" => "Шаблон повідомлення",
    "telegram_template_placeholders_info" => "Плейсхолдери: {name} - назва, {price} - ціна, {next_payment} - дата, {days_left} - днів до, {url} - сайт, {category} - категорія, {notes} - нотатки. Підтримує HTML: <b>жирний</b>",
]
