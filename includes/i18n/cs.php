...
$i18n = [
    ...
    "new_subscription_defaults" => "Výchozí hodnoty nového předplatného",
    "default_auto_renew" => "Ve výchozím nastavení povolit automatické obnovení",
    "default_notifications" => "Ve výchozím nastavení povolit oznámení",
