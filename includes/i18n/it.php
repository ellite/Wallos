...
$i18n = [
    ...
    "new_subscription_defaults" => "Valori predefiniti nuova iscrizione",
    "default_auto_renew" => "Abilita rinnovo automatico per impostazione predefinita",
    "default_notifications" => "Abilita notifiche per impostazione predefinita",
