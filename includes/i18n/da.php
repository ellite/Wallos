...
$i18n = [
    ...
    "new_subscription_defaults" => "Standardindstillinger for nyt abonnement",
    "default_auto_renew" => "Aktiver automatisk fornyelse som standard",
    "default_notifications" => "Aktiver notifikationer som standard",
