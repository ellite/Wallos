...
$i18n = [
    ...
    "instance_telegram_bot" => "Instance Telegram Bot",
    "instance_telegram_bot_info" => "One bot for the whole installation: every account that leaves its own bot token empty sends through this one, with its own chat id. Leave empty to have each account use a bot of its own.",
    "instance_telegram_bot_in_use" => "This installation provides a Telegram bot. Leave the token empty to use it, and enter your chat id below.",
    "instance_telegram_saved" => "Telegram bot saved",
