...
$i18n = [
    ...
    "instance_ntfy_server" => "Instance ntfy Server",
    "instance_ntfy_server_info" => "One server for the whole installation: every account that leaves its own server empty publishes to this one, under its own topic. The headers are the credential for this server and are never sent to a server an account configured itself.",
    "instance_ntfy_server_in_use" => "This installation provides an ntfy server. Leave the server empty to use it, and enter your topic below.",
    "instance_ntfy_saved" => "ntfy server saved",
