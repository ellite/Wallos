...
$i18n = [
    ...
    "instance_gotify_server" => "Instance Gotify Server",
    "instance_gotify_server_info" => "One server for the whole installation: every account that leaves its own server empty sends to this one. Only the address is shared - each account keeps its own application token, so its messages arrive under its own Gotify application.",
    "instance_gotify_server_in_use" => "This installation provides a Gotify server. Leave the server empty to use it, and enter your own application token below.",
    "instance_gotify_saved" => "Gotify server saved",
