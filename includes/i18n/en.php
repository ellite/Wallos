...
$i18n = [
    ...
    "new_subscription_defaults" => "New Subscription Defaults",
    "default_auto_renew" => "Enable auto-renew by default",
    "default_notifications" => "Enable notifications by default",
