...
$i18n = [
    ...
    "instance_pushover_application" => "Instance Pushover Application",
    "instance_pushover_application_info" => "One application for the whole installation: every account that leaves its own application token empty sends through this one, with its own user key. Leave empty to have each account register an application of its own.",
    "instance_pushover_application_in_use" => "This installation provides a Pushover application. Leave the application token empty to use it, and enter your own user key below.",
    "instance_pushover_saved" => "Pushover application saved",
