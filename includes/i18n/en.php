...
$i18n = [
    ...
    "period_budget_info" => "The payment period replaces the calendar month across your statistics. Set the anchor date to your payslip date so \"amount due\" is what is left to pay out of this pay cheque. The budget amount is optional.",
    "budget_period" => "Budget period",
    "budget_anchor_date" => "Anchor date",
    "payment_period" => "Payment period",
    "use_custom_period" => "Use this period instead of calendar months in statistics",
    "custom_period_active_warning" => "Your statistics, dashboard and calendar will follow this period instead of calendar months.",
    "custom_period_same_as_month" => "This period is the same as a calendar month, so your statistics will not change. Set the anchor date to the day you are paid.",
    "amount_due_this_period" => "Amount due this period",
    "fortnightly" => "Fortnight(s)",
    "semimonthly" => "Twice a month",
    "budget_second_payday" => "Second payday",
