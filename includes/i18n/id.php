...
$i18n = [
    ...
    "new_subscription_defaults" => "Default Langganan Baru",
    "default_auto_renew" => "Aktifkan perpanjangan otomatis secara default",
    "default_notifications" => "Aktifkan notifikasi secara default",
