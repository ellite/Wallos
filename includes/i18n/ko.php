...
$i18n = [
    ...
    "monthly_budget_info" => "월간 예산은 구독의 총 월간 비용과 비교됩니다.",
    "period_budget" => "기간 예산",
    "period_budget_info" => "기간 예산은 선택한 예산 기간 내에 지불해야 하는 금액을 추적합니다.",
    "budget_period" => "예산 기간",
    "budget_anchor_date" => "기준 날짜",
    "fortnightly" => "2주",
    "cost_vs_monthly_budget" => "비용 대 월간 예산",
    "cost_vs_period_budget" => "비용 대 기간 예산",
    "send_period_summary_at_period_start" => "각 결제 기간 시작 시 요약 보내기",
    "amount_for_pay_period" => "결제 기간 금액",
    "remaining" => "남음",
    "amount_needed_this_period" => "이번 기간에 필요한 금액",
    ...
    "ai_provider_error" => "AI 제공업체 오류",
    "ai_invalid_response" => "AI 제공업체가 잘못된 응답을 반환했습니다.",
    "ai_invalid_json_response" => "AI 응답에 유효한 추천이 포함되어 있지 않았습니다.",
