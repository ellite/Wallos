...
$i18n = [
    ...
    "new_subscription_defaults" => "Προεπιλογές νέας συνδρομής",
    "default_auto_renew" => "Ενεργοποίηση αυτόματης ανανέωσης από προεπιλογή",
    "default_notifications" => "Ενεργοποίηση ειδοποιήσεων από προεπιλογή",
