...
$i18n = [
    ...
    "repeat_until_paid" => "Επανάληψη ειδοποιήσεων καθημερινά μέχρι πληρωμής",
    "repeat_until_paid_info" => "Όταν ενεργοποιηθεί, θα στέλνονται ειδοποιήσεις κάθε μέρα από την ημερομηνία υπενθύμισης μέχρι να σημειώσετε τη συνδρομή ως πληρωμένη.",
    "telegram_message_template" => "Πρότυπο μηνύματος",
    "telegram_template_placeholders_info" => "Placeholders: {name} - όνομα, {price} - τιμή, {next_payment} - ημερομηνία, {days_left} - ημέρες έως, {url} - ιστότοπος, {category} - κατηγορία, {notes} - σημειώσεις. Υποστηρίζει HTML: <b>έντονα</b>",
];
