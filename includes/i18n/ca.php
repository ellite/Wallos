...
$i18n = [
    ...
    "new_subscription_defaults" => "Valors predeterminats de la nova subscripció",
    "default_auto_renew" => "Activa la renovació automàtica per defecte",
    "default_notifications" => "Activa les notificacions per defecte",
