...
$i18n = [
    ...
    "new_subscription_defaults" => "Valores predeterminados de nueva suscripción",
    "default_auto_renew" => "Habilitar renovación automática por defecto",
    "default_notifications" => "Habilitar notificaciones por defecto",
