...
$i18n = [
    ...
    "new_subscription_defaults" => "Predefinições para nova subscrição",
    "default_auto_renew" => "Ativar renovação automática por defeito",
    "default_notifications" => "Ativar notificações por defeito",
