...
$i18n = [
    ...
    "new_subscription_defaults" => "Domyślne wartości nowej subskrypcji",
    "default_auto_renew" => "Domyślnie włącz automatyczne odnawianie",
    "default_notifications" => "Domyślnie włącz powiadomienia",
