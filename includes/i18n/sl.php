...
$i18n = [
    ...
    "new_subscription_defaults" => "Privzete vrednosti za novo naročnino",
    "default_auto_renew" => "Privzeto omogoči samodejno podaljšanje",
    "default_notifications" => "Privzeto omogoči obvestila",
