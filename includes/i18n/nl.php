...
$i18n = [
    ...
    "new_subscription_defaults" => "Standaardwaarden nieuw abonnement",
    "default_auto_renew" => "Automatisch verlengen standaard inschakelen",
    "default_notifications" => "Meldingen standaard inschakelen",
