...
$i18n = [
    ...
    "new_subscription_defaults" => "Подразумеване вредности новог претплатног плана",
    "default_auto_renew" => "Подразумевано омогући аутоматско обнављање",
    "default_notifications" => "Подразумевано омогући обавештења",
