...
$i18n = [
    ...
    "new_subscription_defaults" => "Параметры по умолчанию для новой подписки",
    "default_auto_renew" => "Включить автоматическое продление по умолчанию",
    "default_notifications" => "Включить уведомления по умолчанию",
